...
func Test_SyncStack_Empty(t *testing.T) {
...
func Test_SyncStack_WithData(t *testing.T) {
	stack := NewSyncStack[int]()
...
func Test_SyncStack_Multiple(t *testing.T) {
	stack := NewSyncStack[int]()
...
func Test_SyncStack_Clear(t *testing.T) {
	stack := NewSyncStack[int]()
...
func Test_SyncStack_Stream(t *testing.T) {
	stack := NewSyncStack[int]()
